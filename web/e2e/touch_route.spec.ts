      ...
      rotate: { azimuth_delta: az, dpr1_azimuth_delta: one, ratio: az / one!,
                ...
                az_tol_basis: {
                  ...
                  why: "**옛 임계 1e-6은 이 기계 밴드의 175만 배**라 0/12로 아무것도 안 갈랐다"
                     + "(#40 계열 — 검사가 통과하는데 아무것도 안 잰다). 밴드 상단의 17.5배로 "
                     + "내렸다(**선정 시점의 배수** — 밴드가 실행 묶음마다 움직이므로 현행 배수는 "
                     + "ratio_to_band_max 필드를 읽는다, 10차 정정). "
                     + "⚠ **오배선의 신호와는 여전히 다섯 자리 위 여유가 있다**: "
                ...
                az_tol_note: "판정은 |az−dpr1| < az_tol_rad(⚠ 10차 정정: 아래 '1e-6' 연혁 서술은 6차 개정 시점의 값이고 **현행 임계는 az_tol_rad 필드**다 — 9차 항목 3이 1e-11로 내렸다). 연혁: 6차 항목 1에서 1e-6으로 개정(#28 — 옛 정밀도 12"
