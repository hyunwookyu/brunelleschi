    ...
    const doc = {
      ...
      gate: gate({
        ...
        status: "살아 있다. L-A 게이트(`lift_gate`)는 2026-08-15에 실패했고 이것이 그 재등록이다. "
          + "⚠⚠ **통과선을 넘는 유일한 행이 `deg_0.25`다**: 형태 오차 0.0613 ≤ 0.0296×2.1 = 0.0622이고 "
          + "조용히 틀림 0.0696 ≤ 0.0673×1.1 = 0.0740이다. **등록 지점인 `deg_0.5`는 둘 다 넘는다** "
          + "(0.1085 > 0.0622 · 0.0835 > 0.0740). 즉 **실효 요구는 등록한 0.5°가 아니라 ≈0.25°이고 "
          + "두 배 엄격하다.** 기준을 안 고친다(#26) — 적기만 한다.",
      }),
