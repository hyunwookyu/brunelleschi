  ...
  it("측정을 원장에 남긴다", () => {
    ...
    const doc = {
      ...
      gate: gate({
        ...
        // 자명하지 않은 수치는 **캔버스가 정하는 상한**이다 — "구성상 확인 가능"은 측정이
        // 잘 정의됐다는 말이지 기준을 넘을 수 있다는 말이 아니었다(#40).
        reachability_value: 588.18,
        reachability_source: "extend_ceiling/canvas_chord_max_px",
