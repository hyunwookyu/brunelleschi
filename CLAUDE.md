...
| | 재는 것 | 임계 | 표본 | 측정값 |
|---|---|---|---|---|
| **현행 게이트** | `optimal_rate` — 검출 엣지 수 == 허용오차를 지키는 **최소** 엣지 수인 획 비율 | **0.5** (원 조건의 임계를 그대로 옮김) | Quick,Draw raw 폐곡선 n≈1800, 정답 라벨 불요 | **0.692** ✅ |
...
채택 0.694, 둔감 끝 0.477). 산출: `stage0/out/edge_fidelity.json`.
