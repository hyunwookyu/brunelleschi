...
/** 조건이 낸 목록(2026-09-04 · web2-61에서 shots61(toDataURL — 사진 산출물)이 늘었다 · 58에서 52 → 59·60에서 54 → 61에서 55) — 갱신은 조건을 다시 돌려서만 한다. */
export const DPR2_SPECS = [
  ...
  'grain26', 'grain30', 'grain40', 'graphite', 'icons', 'inklayer', 'input', 'mark58',
  'join56', 'level', 'materials', 'mats46', 'mats52', 'nums47', 'own3d', 'paint45',
  'paint48', 'paint50', 'paint54', 'paint59', 'quality60', 'paper', 'papericon31', 'press26', 'rep49', 'rollpose',
  'roundsave', 'shots61', 'slide40', 'snapghost', 'span57', 'thick55', 'turn31', 'ui34r7', 'underlay', 'view42',
