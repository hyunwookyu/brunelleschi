...
/** 조건이 낸 목록(2026-09-03 · web2-58에서 mark58이 늘어 52 · web2-59에서 paint59가 늘어 53) — 갱신은 조건을 다시 돌려서만 한다. */
export const DPR2_SPECS = [
  ...
  'paint48', 'paint50', 'paint54', 'paint59', 'paper', 'papericon31', 'press26', 'rep49', 'rollpose',
