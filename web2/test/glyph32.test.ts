  ...
  it('전체가 오르고 비 0.65↔1.00의 격차가 좁혀진다 · 잡음 수용은 0으로 남는다', () => {
    ...
    writeFileSync(out, JSON.stringify({
      ...
      flags_explained: {
        ...
        '세리프 1이 안 오른다': '**측정이 지시의 가설을 반증했다**(D-4). 세션 지시는 「세리프 1도 같은 뿌리(폭이 크게 변한다)」로 봤는데, 정규화는 세리프 1을 **안 고친다**(전과 같다: 5/0/0/2 · 9/1/0/12). 편 시야에서는 오히려 0/0/0/0이라 구제가 안 걸린다 — 뿌리가 다르다. assumptions.md AS-C111.',
      },
